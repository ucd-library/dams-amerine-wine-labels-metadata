...
** 2023-08 Processing
   ...
   city/region, abv, proof marginalia.

   We'll save this data to the metadata, but for now, we are only going to
   update the name for the wine.  We'll save the data in repo however.

   Originally, there was not an identifier for the collection;  I have minted,
   ark:/87287/d7794w for this collection.  We will add two identifiers, the
   label# and the individual label arks.
